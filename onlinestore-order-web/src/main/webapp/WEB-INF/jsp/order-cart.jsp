...
<form id="orderForm" class="hide" action="/order/create.html" method="post">
		...
		<c:forEach items="${cartList }" var="cart" varStatus="status">
			...
			<input type="hidden" name="orderItems[${status.index}].itemId" value="${cart.id}"/>//orderItems说明是一个数组
		...
		<input type="hidden" name="orderShipping.receiverName" value="张永斌"/>
