 ...
 * Generated at: 2018-07-16 09:57:05 UTC
...
public final class item_002dlist_jsp extends org.apache.jasper.runtime.HttpJspBase
  ...
  public void _jspService(final javax.servlet.http.HttpServletRequest request, final javax.servlet.http.HttpServletResponse response)
    ...
    try {
      ...
      out.write("        handler:function(){\r\n");
      out.write("        \tvar ids = getSelectionsIds();//获取所有当前选中数据的ids\r\n");
      ...
      out.write("        \t}\r\n");
      out.write("        \t\r\n");
      out.write("        \t$(\"#itemEditWindow\").window({//打开编辑商品的窗口\r\n");
      out.write("        \t\tonLoad :function(){\r\n");
      out.write("        \t\t\t//回显数据,这个时候回显的数据时，商品类目的值回显成了商品类型的id而不是名字\r\n");
      ...
      out.write("        \t\t\t});\r\n");
      out.write("        \t\t\t\r\n");
      out.write("        \t\t\t//加载商品规格,查tb_item_param_item表\r\n");
      out.write("        \t\t\t$.getJSON('/item/param/'+data.id,function(_data){\r\n");
